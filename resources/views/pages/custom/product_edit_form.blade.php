        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            ...
            <div class="col-span-12 grid lg:col-span-8">
                <div class="card">
                    ...
                    <form action="{{ route('custom/product_edit_update', $id=$product->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    <div class="space-y-4 p-4 sm:p-5">
                        <label class="block">
                            ...
                            <input
                                ...
                                placeholder="Enter product name" type="text" name="name" value="{{ $product->name }}" />
                        </label>
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <label class="block">
                                <span>Slug</span>
                                <input type="text" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="slug"  value="{{ $product->slug }}">
                            </label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="block">
                                    ...
                                    <input
                                        class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                        placeholder="SKU" type="color" name="color"  value="{{ $product->color }}" />
                                </label>
                                ...
                                <label class="block">
                                    ...
                                    <input
                                        class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                        placeholder="Price" type="number" name="price"  value="{{ $product->price }}" />
                                </label>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="filepond fp-bordered fp-grid mt-1.5 [--fp-grid:2]">
                                <img src="/product/images/{{ $product->image }}" alt="" width="50" height="50">
                        ...
                        <div class="flex justify-center space-x-2 pt-4">
                            ...
                            <button
                                class="btn space-x-2 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" type="submit">
                                <span>Next</span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
