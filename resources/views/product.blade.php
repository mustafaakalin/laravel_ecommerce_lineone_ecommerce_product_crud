...
<div class="container mx-auto px-6">
    <div class="md:flex md:items-center">
        <div class="w-full h-64 md:w-1/2 lg:h-96">
            <img class="h-full w-full rounded-md object-cover max-w-lg mx-auto" src="/product/images/{{ $product->image }}" alt="{{ $product->name }}">
        </div>
        <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
            ...
            <div class="mt-3">
                ...
                <div class="flex items-center mt-1">
                    <button class="h-5 w-5 rounded-full  border-2 border-blue-200 mr-2 focus:outline-none" style="background-color:{{ $product->color }}"></button>
    ...
    <div class="mt-16">
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
            ...
            <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('{{ url('product/images/' . $item->image) }}')">
